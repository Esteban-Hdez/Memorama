!(function (t, e) {
  ...
  function et(t) {
    _e.isVisible() && it !== t.target.value && _e.resetValidationMessage(),
      (it = t.target.value);
  }
  function nt(t, e) {
  ...
  (Ct.text =
    ...
    (Ct.textarea = function (t) {
      var e = st(_(), x.textarea);
      return (e.value = t.inputValue), gt(e, t), e;
    });
  function kt(t, e) {
    var n = _().querySelector("#" + x.content);
    e.html
  ...
  function xt(t, i) {
    ...
    L(r), (r.innerHTML = "");
    var a = parseInt(
      null === i.currentProgressStep ? _e.getQueueStep() : i.currentProgressStep
    );
      ...
      (function (t, e) {
        ...
        if (n && e.type === n.type && N()) y(N(), e.customClass, "icon");
          ...
          if ((Et(), -1 !== Object.keys(P).indexOf(e.type))) {
            var o = q(".".concat(x.icon, ".").concat(P[e.type]));
            L(o),
            ...
            a(e, [
              {
                key: "_main",
                value: function (t) {
                  return f(u(e.prototype), "_main", this).call(
                    this,
                    s({}, n, t)
                  );
                },
  ...
  function Kt(t, e, n, o) {
    n
      ...
      G() &&
        (null !== S.previousBodyPadding &&
          ((document.body.style.paddingRight = S.previousBodyPadding + "px"),
          (S.previousBodyPadding = null)),
        (function () {
  ...
  var de = function (t, e) {
      ft && H(e)
        ? ((t.style.overflowY = "hidden"),
          e.addEventListener(ft, ne.bind(null, e, t)))
